...
namespace GSys.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeletePlayerStoreRequest")]
    public partial class DeletePlayerStoreRequest : IEquatable<DeletePlayerStoreRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeletePlayerStoreRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeletePlayerStoreRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeletePlayerStoreRequest" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public DeletePlayerStoreRequest(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeletePlayerStoreRequest {\n");
        ...
        {
            return this.Equals(input as DeletePlayerStoreRequest);
        }

        /// <summary>
        /// Returns true if DeletePlayerStoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeletePlayerStoreRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeletePlayerStoreRequest input)
        {
            if (input == null)
            {
                return false;
