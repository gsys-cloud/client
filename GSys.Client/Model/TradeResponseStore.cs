...
namespace GSys.Client.Model
{
    ...
    /// TradeResponseStore
    /// </summary>
    [DataContract(Name = "TradeResponseStore")]
    public partial class TradeResponseStore : IEquatable<TradeResponseStore>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeResponseStore" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TradeResponseStore() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeResponseStore" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public TradeResponseStore(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeResponseStore {\n");
        ...
        {
            return this.Equals(input as TradeResponseStore);
        }

        /// <summary>
        /// Returns true if TradeResponseStore instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeResponseStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeResponseStore input)
        {
            if (input == null)
            {
                return false;
