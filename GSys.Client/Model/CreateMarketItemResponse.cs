...
namespace GSys.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateMarketItemResponse")]
    public partial class CreateMarketItemResponse : IEquatable<CreateMarketItemResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMarketItemResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateMarketItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMarketItemResponse" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public CreateMarketItemResponse(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMarketItemResponse {\n");
        ...
        {
            return this.Equals(input as CreateMarketItemResponse);
        }

        /// <summary>
        /// Returns true if CreateMarketItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateMarketItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMarketItemResponse input)
        {
            if (input == null)
            {
                return false;
