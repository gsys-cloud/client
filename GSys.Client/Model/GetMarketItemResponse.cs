...
namespace GSys.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetMarketItemResponse")]
    public partial class GetMarketItemResponse : IEquatable<GetMarketItemResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMarketItemResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMarketItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMarketItemResponse" /> class.
        /// </summary>
        ...
        public GetMarketItemResponse(int blocks = default(int), GetMarketItemResponseOrders orders = default(GetMarketItemResponseOrders), long revision = default(long))
        {
            this.Blocks = blocks;
            // to ensure "orders" is required (not null)
            if (orders == null)
            {
                throw new ArgumentNullException("orders is a required property for GetMarketItemResponse and cannot be null");
            }
            this.Orders = orders;
        ...
        public GetMarketItemResponseOrders Orders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetMarketItemResponse {\n");
        ...
        {
            return this.Equals(input as GetMarketItemResponse);
        }

        /// <summary>
        /// Returns true if GetMarketItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetMarketItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMarketItemResponse input)
        {
            if (input == null)
            {
                return false;
