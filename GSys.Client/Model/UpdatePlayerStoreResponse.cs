...
{
    /// <summary>
    /// UpdatePlayerStoreResponse
    /// </summary>
    [DataContract(Name = "UpdatePlayerStoreResponse")]
    public partial class UpdatePlayerStoreResponse : IEquatable<UpdatePlayerStoreResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePlayerStoreResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdatePlayerStoreResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePlayerStoreResponse" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public UpdatePlayerStoreResponse(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePlayerStoreResponse {\n");
        ...
        {
            return this.Equals(input as UpdatePlayerStoreResponse);
        }

        /// <summary>
        /// Returns true if UpdatePlayerStoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePlayerStoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePlayerStoreResponse input)
        {
            if (input == null)
            {
                return false;
