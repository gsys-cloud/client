...
{
    /// <summary>
    /// CreatePlayerStoreResponse
    /// </summary>
    [DataContract(Name = "CreatePlayerStoreResponse")]
    public partial class CreatePlayerStoreResponse : IEquatable<CreatePlayerStoreResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlayerStoreResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreatePlayerStoreResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlayerStoreResponse" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public CreatePlayerStoreResponse(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatePlayerStoreResponse {\n");
        ...
        {
            return this.Equals(input as CreatePlayerStoreResponse);
        }

        /// <summary>
        /// Returns true if CreatePlayerStoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePlayerStoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePlayerStoreResponse input)
        {
            if (input == null)
            {
                return false;
