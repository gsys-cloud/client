...
{
    /// <summary>
    /// GetPlayerStoreResponse
    /// </summary>
    [DataContract(Name = "GetPlayerStoreResponse")]
    public partial class GetPlayerStoreResponse : IEquatable<GetPlayerStoreResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayerStoreResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPlayerStoreResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayerStoreResponse" /> class.
        /// </summary>
        ...
        public GetPlayerStoreResponse(int blocks = default(int), System.IO.Stream data = default(System.IO.Stream), long revision = default(long))
        {
            this.Blocks = blocks;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetPlayerStoreResponse and cannot be null");
            }
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPlayerStoreResponse {\n");
        ...
        {
            return this.Equals(input as GetPlayerStoreResponse);
        }

        /// <summary>
        /// Returns true if GetPlayerStoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPlayerStoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPlayerStoreResponse input)
        {
            if (input == null)
            {
                return false;
