...
{
    /// <summary>
    /// DeleteMarketItemRequest
    /// </summary>
    [DataContract(Name = "DeleteMarketItemRequest")]
    public partial class DeleteMarketItemRequest : IEquatable<DeleteMarketItemRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMarketItemRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteMarketItemRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMarketItemRequest" /> class.
        /// </summary>
        /// <param name="blocks">blocks (required).</param>
        /// <param name="revision">revision (required).</param>
        public DeleteMarketItemRequest(int blocks = default(int), long revision = default(long))
        {
            this.Blocks = blocks;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMarketItemRequest {\n");
        ...
        {
            return this.Equals(input as DeleteMarketItemRequest);
        }

        /// <summary>
        /// Returns true if DeleteMarketItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteMarketItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteMarketItemRequest input)
        {
            if (input == null)
            {
                return false;
